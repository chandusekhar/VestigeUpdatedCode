...
namespace TransfersComponent.BusinessObjects
{
    ...
    public class TOI : TransferOrder
    {
        ...
        decimal m_totalTOIQuantity, m_totalTOITaxAmount, m_totalTOIAmount,m_TotalTOIWeight;
        ...
        public decimal DBTotalTOIWeight
        {
            get { return Math.Round(TotalTOIWeight/1000, Common.DBAmountRounding, MidpointRounding.AwayFromZero); }
            set { throw new NotImplementedException("This Property cannot be explicitly set"); }
        }
        public decimal DisplayTotalTOIWeight
        {
            get { return Math.Round(DBTotalTOIWeight, Common.DisplayAmountRounding, MidpointRounding.AwayFromZero); }
            set { throw new NotImplementedException("This Property cannot be explicitly set"); }
        }
        ...
        public decimal TotalTOIWeight
        {
            get { return m_TotalTOIWeight; }
            set { m_TotalTOIWeight = value; }
        }
        ...
        public List<TOI> Search()
        {
            ...
            try
            {
                ...
                foreach (System.Data.DataRow drow in dTable.Rows)
                {
                    ...
                    objTOI.TotalTOIWeight = Convert.ToDecimal(drow["TotalTOIWeight"] );
                    if (columnSearched == 1)
        ...
        public List<TOIDetail> SearchItem(string toiNumber, int sourceAddressId)
        {
            ...
            try
            {
                ...
                foreach (System.Data.DataRow drow in dTable.Rows)
                {
                    ...
                    objTOI.LineWeight = Convert.ToInt32(drow["LineWeight"]);
